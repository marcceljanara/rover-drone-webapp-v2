...
export default function Shipments() {
  ...
  const [courier,  setCourier]    = useState("");   // filter
    ...
    <div className="ship-container">
      ...
      <div className="ship-table-wrapper">
        ...
        <table className="ship-table">
          ...
          <tbody>
            {loading ? (
              <tr><td colSpan="6" className="ship-loading">Memuat…</td></tr>
            ) : shipments.length ? (
              shipments.map((s, i) => (
                <tr key={s.id}>
                  <td>{i+1}</td>
                  ...
                  <td>{s.courier_name} / {s.courier_service}</td>
              ...
              <tr><td colSpan="6" className="ship-empty">Tidak ada data</td></tr>
            )}
          </tbody>
        </table>
      </div>
